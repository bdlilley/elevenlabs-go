...
func (s *ForcedAlignment) ForcedAlignment(ctx context.Context, request components.BodyCreateForcedAlignmentV1ForcedAlignmentPost, opts ...operations.Option) (*operations.ForcedAlignmentResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v1/forced-alignment")
	if err != nil {
	...
	res := &operations.ForcedAlignmentResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.ForcedAlignmentResponseModel
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.ForcedAlignmentResponseModel = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err

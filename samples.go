...
func (s *Samples) DeleteSample(ctx context.Context, voiceID string, sampleID string, xiAPIKey optionalnullable.OptionalNullable[string], opts ...operations.Option) (*operations.DeleteSampleResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/voices/{voice_id}/samples/{sample_id}", request, nil)
	if err != nil {
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.DeleteSampleResponseModel
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.DeleteSampleResponseModel = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err
...
func (s *Samples) GetAudioFromSample(ctx context.Context, voiceID string, sampleID string, xiAPIKey optionalnullable.OptionalNullable[string], opts ...operations.Option) (*operations.GetAudioFromSampleResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/voices/{voice_id}/samples/{sample_id}/audio", request, nil)
	if err != nil {
		return nil, fmt.Errorf("error generating URL: %w", err)
	}
	...
	res := &operations.GetAudioFromSampleResponse{
		HTTPMeta: components.HTTPMetadata{
			Request:  req,
			Response: httpRes,
		},

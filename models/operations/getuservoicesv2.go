...
type GetUserVoicesV2Request struct {
	...
	FineTuningState *string `queryParam:"style=form,explode=true,name=fine_tuning_state"`
	...
	VoiceIds []string `queryParam:"style=form,explode=true,name=voice_ids"`
}
...
func (g *GetUserVoicesV2Request) GetNextPageToken() *string {
	if g == nil {
		return nil
	}
...
func (g *GetUserVoicesV2Request) GetSearch() *string {
	if g == nil {
		return nil
	}
	return g.Search
...
func (g *GetUserVoicesV2Request) GetSort() *string {
	if g == nil {
		return nil
	}
	return g.Sort
...
func (g *GetUserVoicesV2Request) GetSortDirection() *string {
	if g == nil {
		return nil
	}
...
func (g *GetUserVoicesV2Request) GetVoiceType() *string {
	if g == nil {
		return nil
	}
	return g.VoiceType
...
func (g *GetUserVoicesV2Request) GetCategory() *string {
	if g == nil {
		return nil
	}
	return g.Category
...
func (g *GetUserVoicesV2Request) GetFineTuningState() *string {
	if g == nil {
		return nil
	}
...
func (g *GetUserVoicesV2Request) GetCollectionID() *string {
	if g == nil {
		return nil
	}
...
func (g *GetUserVoicesV2Request) GetVoiceIds() []string {
	if g == nil {
		return nil
	}
	return g.VoiceIds

...
func (b *BodyComposeMusicV1MusicPost) GetPrompt() optionalnullable.OptionalNullable[string] {
	if b == nil {
		return nil
	}
	return b.Prompt
...
func (b *BodyComposeMusicV1MusicPost) GetMusicPrompt() optionalnullable.OptionalNullable[MusicPrompt] {
	if b == nil {
		return nil
	}
...
func (b *BodyComposeMusicV1MusicPost) GetCompositionPlan() optionalnullable.OptionalNullable[MusicPrompt] {
	if b == nil {
		return nil
	}
...
func (b *BodyComposeMusicV1MusicPost) GetMusicLengthMs() optionalnullable.OptionalNullable[int64] {
	if b == nil {
		return nil
	}
...
func (b *BodyComposeMusicV1MusicPost) GetSeed() optionalnullable.OptionalNullable[int64] {
	if b == nil {
		return nil
	}
	return b.Seed
...
func (b *BodyComposeMusicV1MusicPost) GetFinetuneID() optionalnullable.OptionalNullable[string] {
	if b == nil {
		return nil
	}
	return b.FinetuneID

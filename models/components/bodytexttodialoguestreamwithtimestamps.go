...
func (e BodyTextToDialogueStreamWithTimestampsApplyTextNormalization) ToPointer() *BodyTextToDialogueStreamWithTimestampsApplyTextNormalization {
	return &e
}
func (e *BodyTextToDialogueStreamWithTimestampsApplyTextNormalization) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "on":
		fallthrough
	case "off":
		*e = BodyTextToDialogueStreamWithTimestampsApplyTextNormalization(v)
		return nil
	default:
		return fmt.Errorf("invalid value for BodyTextToDialogueStreamWithTimestampsApplyTextNormalization: %v", v)
	}
}
...
func (b BodyTextToDialogueStreamWithTimestamps) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(b, "", false)
}

func (b *BodyTextToDialogueStreamWithTimestamps) UnmarshalJSON(data []byte) error {
...
func (b *BodyTextToDialogueStreamWithTimestamps) GetInputs() []DialogueInput {
	if b == nil {
...
func (b *BodyTextToDialogueStreamWithTimestamps) GetModelID() *string {
	if b == nil {
		return nil
	}
	return b.ModelID
...
func (b *BodyTextToDialogueStreamWithTimestamps) GetApplyTextNormalization() *BodyTextToDialogueStreamWithTimestampsApplyTextNormalization {
	if b == nil {
		return nil
	}

...
func (e BodyTextToSpeechFullApplyTextNormalization) ToPointer() *BodyTextToSpeechFullApplyTextNormalization {
	return &e
}
func (e *BodyTextToSpeechFullApplyTextNormalization) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "on":
		fallthrough
	case "off":
		*e = BodyTextToSpeechFullApplyTextNormalization(v)
		return nil
	default:
		return fmt.Errorf("invalid value for BodyTextToSpeechFullApplyTextNormalization: %v", v)
	}
}
...
func (b *BodyTextToSpeechFull) UnmarshalJSON(data []byte) error {
...
func (b *BodyTextToSpeechFull) GetText() string {
	if b == nil {
		return ""
	}
	return b.Text
...
func (b *BodyTextToSpeechFull) GetModelID() *string {
	if b == nil {
		return nil
	}
	return b.ModelID
...
func (b *BodyTextToSpeechFull) GetUsePvcAsIvc() *bool {
	if b == nil {
		return nil
	}
...
func (b *BodyTextToSpeechFull) GetApplyTextNormalization() *BodyTextToSpeechFullApplyTextNormalization {
	if b == nil {
		return nil
	}
...
func (b *BodyTextToSpeechFull) GetApplyLanguageTextNormalization() *bool {
	if b == nil {
		return nil
	}

...
func (b *BodyTextToDialogueFullWithTimestamps) GetLanguageCode() optionalnullable.OptionalNullable[string] {
	if b == nil {
		return nil
	}
...
func (b *BodyTextToDialogueFullWithTimestamps) GetSettings() optionalnullable.OptionalNullable[ModelSettingsResponseModel] {
	if b == nil {
		return nil
	}
	return b.Settings
...
func (b *BodyTextToDialogueFullWithTimestamps) GetPronunciationDictionaryLocators() optionalnullable.OptionalNullable[[]PronunciationDictionaryVersionLocatorRequestModel] {
	if b == nil {
		return nil
	}
...
func (b *BodyTextToDialogueFullWithTimestamps) GetSeed() optionalnullable.OptionalNullable[int64] {
	if b == nil {
		return nil
	}
	return b.Seed

...
type TTSConversationalConfigOutput struct {
	...
	EnablePhonemeTags *bool `default:"false" json:"enable_phoneme_tags"`
...
func (t *TTSConversationalConfigOutput) GetEnablePhonemeTags() *bool {
	if t == nil {
		return nil
	}
...
func (t *TTSConversationalConfigOutput) GetAudioFilter() *AudioFilterID {
	if t == nil {
		return nil
	}

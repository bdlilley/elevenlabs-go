...
func (e BodyTextToSpeechStreamApplyTextNormalization) ToPointer() *BodyTextToSpeechStreamApplyTextNormalization {
	return &e
}
func (e *BodyTextToSpeechStreamApplyTextNormalization) UnmarshalJSON(data []byte) error {
	var v string
	...
	case "on":
		fallthrough
	case "off":
		*e = BodyTextToSpeechStreamApplyTextNormalization(v)
		return nil
	default:
		return fmt.Errorf("invalid value for BodyTextToSpeechStreamApplyTextNormalization: %v", v)
	}
}
...
type BodyTextToSpeechStream struct {
	...
	ApplyTextNormalization *BodyTextToSpeechStreamApplyTextNormalization `default:"auto" json:"apply_text_normalization"`
...
func (b BodyTextToSpeechStream) MarshalJSON() ([]byte, error) {
	return utils.MarshalJSON(b, "", false)
}

func (b *BodyTextToSpeechStream) UnmarshalJSON(data []byte) error {
...
func (b *BodyTextToSpeechStream) GetText() string {
	if b == nil {
		return ""
	}
	return b.Text
...
func (b *BodyTextToSpeechStream) GetModelID() *string {
	if b == nil {
		return nil
	}
	return b.ModelID
...
func (b *BodyTextToSpeechStream) GetLanguageCode() optionalnullable.OptionalNullable[string] {
	if b == nil {
		return nil
	}
...
func (b *BodyTextToSpeechStream) GetVoiceSettings() optionalnullable.OptionalNullable[VoiceSettingsResponseModel] {
	if b == nil {
		return nil
	}
...
func (b *BodyTextToSpeechStream) GetPronunciationDictionaryLocators() optionalnullable.OptionalNullable[[]PronunciationDictionaryVersionLocatorRequestModel] {
	if b == nil {
		return nil
	}
...
func (b *BodyTextToSpeechStream) GetSeed() optionalnullable.OptionalNullable[int64] {
	if b == nil {
		return nil
	}
	return b.Seed
...
func (b *BodyTextToSpeechStream) GetPreviousText() optionalnullable.OptionalNullable[string] {
	if b == nil {
		return nil
	}
...
func (b *BodyTextToSpeechStream) GetNextText() optionalnullable.OptionalNullable[string] {
	if b == nil {
		return nil
	}
	return b.NextText
...
func (b *BodyTextToSpeechStream) GetPreviousRequestIds() optionalnullable.OptionalNullable[[]string] {
	if b == nil {
		return nil
	}
...
func (b *BodyTextToSpeechStream) GetNextRequestIds() optionalnullable.OptionalNullable[[]string] {
	if b == nil {
		return nil
	}
...
func (b *BodyTextToSpeechStream) GetUsePvcAsIvc() *bool {
	if b == nil {
		return nil
	}
...
func (b *BodyTextToSpeechStream) GetApplyTextNormalization() *BodyTextToSpeechStreamApplyTextNormalization {
	if b == nil {
		return nil
	}
...
func (b *BodyTextToSpeechStream) GetApplyLanguageTextNormalization() *bool {
	if b == nil {
		return nil
	}
...
func (b *BodyTextToSpeechStream) GetAvatarContext() optionalnullable.OptionalNullable[AvatarContextRequestModel] {
	if b == nil {
		return nil
	}

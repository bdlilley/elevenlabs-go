...
func (b *BodyTextToSpeechStream) GetLanguageCode() *string {
	if b == nil {
		return nil
	}
...
func (b *BodyTextToSpeechStream) GetVoiceSettings() *VoiceSettingsResponseModel {
	if b == nil {
		return nil
	}
...
func (b *BodyTextToSpeechStream) GetPronunciationDictionaryLocators() []PronunciationDictionaryVersionLocatorRequestModel {
	if b == nil {
		return nil
	}
...
func (b *BodyTextToSpeechStream) GetSeed() *int64 {
	if b == nil {
		return nil
	}
	return b.Seed
...
func (b *BodyTextToSpeechStream) GetPreviousText() *string {
	if b == nil {
		return nil
	}
...
func (b *BodyTextToSpeechStream) GetNextText() *string {
	if b == nil {
		return nil
	}
	return b.NextText
...
func (b *BodyTextToSpeechStream) GetPreviousRequestIds() []string {
	if b == nil {
		return nil
	}
...
func (b *BodyTextToSpeechStream) GetNextRequestIds() []string {
	if b == nil {
		return nil
	}
...
func (b *BodyTextToSpeechStream) GetAvatarContext() *AvatarContextRequestModel {
	if b == nil {
		return nil
	}

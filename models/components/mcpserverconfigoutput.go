...
type MCPServerConfigOutput struct {
	...
	ToolConfigOverrides []MCPToolConfigOverrideOutput `json:"tool_config_overrides,omitzero"`
...
func (m *MCPServerConfigOutput) GetPreToolSpeech() *PreToolSpeechMode {
	if m == nil {
		return nil
	}
...
func (m *MCPServerConfigOutput) GetInterruptionMode() *ToolInterruptionMode {
	if m == nil {
		return nil
	}
...
func (m *MCPServerConfigOutput) GetResponseTimeoutSecs() *int64 {
	if m == nil {
		return nil
	}
...
func (m *MCPServerConfigOutput) GetToolConfigOverrides() []MCPToolConfigOverrideOutput {
	if m == nil {
		return nil
	}

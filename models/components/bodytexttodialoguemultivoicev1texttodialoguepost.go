...
func (b *BodyTextToDialogueMultiVoiceV1TextToDialoguePost) GetLanguageCode() optionalnullable.OptionalNullable[string] {
	if b == nil {
		return nil
	}
...
func (b *BodyTextToDialogueMultiVoiceV1TextToDialoguePost) GetSettings() optionalnullable.OptionalNullable[ModelSettingsResponseModel] {
	if b == nil {
		return nil
	}
	return b.Settings
...
func (b *BodyTextToDialogueMultiVoiceV1TextToDialoguePost) GetPronunciationDictionaryLocators() optionalnullable.OptionalNullable[[]PronunciationDictionaryVersionLocatorRequestModel] {
	if b == nil {
		return nil
	}
...
func (b *BodyTextToDialogueMultiVoiceV1TextToDialoguePost) GetSeed() optionalnullable.OptionalNullable[int64] {
	if b == nil {
		return nil
	}
	return b.Seed
...
func (b *BodyTextToDialogueMultiVoiceV1TextToDialoguePost) GetAvatarContext() optionalnullable.OptionalNullable[AvatarContextRequestModel] {
	if b == nil {
		return nil
	}

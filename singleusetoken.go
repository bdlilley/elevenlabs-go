...
func (s *SingleUseToken) GetSingleUseToken(ctx context.Context, tokenType components.SingleUseTokenType, xiAPIKey optionalnullable.OptionalNullable[string], opts ...operations.Option) (*operations.GetSingleUseTokenResponse, error) {
	...
	opURL, err := utils.GenerateURL(ctx, baseURL, "/v1/single-use-token/{token_type}", request, nil)
	if err != nil {
	...
	res := &operations.GetSingleUseTokenResponse{
	...
	case httpRes.StatusCode == 200:
		...
		case utils.MatchContentType(httpRes.Header.Get("Content-Type"), `application/json`):
			...
			var out components.SingleUseTokenResponseModel
			if err := utils.UnmarshalJsonFromResponseBody(bytes.NewBuffer(rawBody), &out, ""); err != nil {
				return nil, err
			}

			res.SingleUseTokenResponseModel = &out
		default:
			rawBody, err := utils.ConsumeRawBody(httpRes)
			if err != nil {
				return nil, err

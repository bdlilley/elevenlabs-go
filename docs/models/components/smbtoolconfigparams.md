...
```go
smbToolConfigParams := components.CreateSMBToolConfigParamsCreateAgentRule(components.CreateAgentRuleParams{/* values here */})
```

### CreateAssetParams

```go
smbToolConfigParams := components.CreateSMBToolConfigParamsCreateAsset(components.CreateAssetParams{/* values here */})
```

### CreateClientParams

```go
smbToolConfigParams := components.CreateSMBToolConfigParamsCreateClient(components.CreateClientParams{/* values here */})
```

### CreateClientAppointmentParams

```go
smbToolConfigParams := components.CreateSMBToolConfigParamsCreateClientAppointment(components.CreateClientAppointmentParams{/* values here */})
```

### CreateClientInteractionParams

```go
smbToolConfigParams := components.CreateSMBToolConfigParamsCreateClientInteraction(components.CreateClientInteractionParams{/* values here */})
```
...
```go
smbToolConfigParams := components.CreateSMBToolConfigParamsCreateService(components.CreateServiceParams{/* values here */})
```
...
```go
smbToolConfigParams := components.CreateSMBToolConfigParamsDeleteAgentRule(components.DeleteAgentRuleParams{/* values here */})
```

### DeleteAssetParams

```go
smbToolConfigParams := components.CreateSMBToolConfigParamsDeleteAsset(components.DeleteAssetParams{/* values here */})
```

### DeleteCalendarEventParams

```go
smbToolConfigParams := components.CreateSMBToolConfigParamsDeleteCalendarEvent(components.DeleteCalendarEventParams{/* values here */})
```

### DeleteClientParams

```go
smbToolConfigParams := components.CreateSMBToolConfigParamsDeleteClient(components.DeleteClientParams{/* values here */})
```
...
```go
smbToolConfigParams := components.CreateSMBToolConfigParamsDeleteService(components.DeleteServiceParams{/* values here */})
```

### DeleteStaffParams

```go
smbToolConfigParams := components.CreateSMBToolConfigParamsDeleteStaff(components.DeleteStaffParams{/* values here */})
```
...
```go
smbToolConfigParams := components.CreateSMBToolConfigParamsGetBookingPageSettings(components.GetBookingPageSettingsParams{/* values here */})
```

### GetBookingSlugStatusParams

```go
smbToolConfigParams := components.CreateSMBToolConfigParamsGetBookingSlugStatus(components.GetBookingSlugStatusParams{/* values here */})
```

### GetClientAppointmentsParams

```go
smbToolConfigParams := components.CreateSMBToolConfigParamsGetClientAppointments(components.GetClientAppointmentsParams{/* values here */})
```

### GetClientByPhoneParams

```go
smbToolConfigParams := components.CreateSMBToolConfigParamsGetClientByPhone(components.GetClientByPhoneParams{/* values here */})
```
...
```go
smbToolConfigParams := components.CreateSMBToolConfigParamsListAgentRules(components.ListAgentRulesParams{/* values here */})
```

### ListAssetsParams

```go
smbToolConfigParams := components.CreateSMBToolConfigParamsListAssets(components.ListAssetsParams{/* values here */})
```

### ListCalendarEventsParams

```go
smbToolConfigParams := components.CreateSMBToolConfigParamsListCalendarEvents(components.ListCalendarEventsParams{/* values here */})
```

### ListClientInteractionsParams

```go
smbToolConfigParams := components.CreateSMBToolConfigParamsListClientInteractions(components.ListClientInteractionsParams{/* values here */})
```
...
```go
smbToolConfigParams := components.CreateSMBToolConfigParamsListServices(components.ListServicesParams{/* values here */})
```
...
```go
smbToolConfigParams := components.CreateSMBToolConfigParamsSearchClients(components.SearchClientsParams{/* values here */})
```
...
```go
smbToolConfigParams := components.CreateSMBToolConfigParamsUpdateAgentRule(components.UpdateAgentRuleParams{/* values here */})
```
...
```go
smbToolConfigParams := components.CreateSMBToolConfigParamsUpdateBookingPageSettings(components.UpdateBookingPageSettingsParams{/* values here */})
```

### UpdateBusinessInfoParams

```go
smbToolConfigParams := components.CreateSMBToolConfigParamsUpdateBusinessInfo(components.UpdateBusinessInfoParams{/* values here */})
```

### UpdateCalendarEventParams

```go
smbToolConfigParams := components.CreateSMBToolConfigParamsUpdateCalendarEvent(components.UpdateCalendarEventParams{/* values here */})
```

### UpdateClientParams

```go
smbToolConfigParams := components.CreateSMBToolConfigParamsUpdateClient(components.UpdateClientParams{/* values here */})
```
...
```go
smbToolConfigParams := components.CreateSMBToolConfigParamsUpdateService(components.UpdateServiceParams{/* values here */})
```

### UpdateStaffParams

```go
smbToolConfigParams := components.CreateSMBToolConfigParamsUpdateStaff(components.UpdateStaffParams{/* values here */})
```
...
switch smbToolConfigParams.Type {
	...
	case components.SMBToolConfigParamsTypeCreateAsset:
		// smbToolConfigParams.CreateAssetParams is populated
	case components.SMBToolConfigParamsTypeCreateClient:
		// smbToolConfigParams.CreateClientParams is populated
	case components.SMBToolConfigParamsTypeCreateClientAppointment:
		// smbToolConfigParams.CreateClientAppointmentParams is populated
	case components.SMBToolConfigParamsTypeCreateClientInteraction:
	...
	case components.SMBToolConfigParamsTypeDeleteAsset:
		// smbToolConfigParams.DeleteAssetParams is populated
	case components.SMBToolConfigParamsTypeDeleteCalendarEvent:
		// smbToolConfigParams.DeleteCalendarEventParams is populated
	case components.SMBToolConfigParamsTypeDeleteClient:
	...
	case components.SMBToolConfigParamsTypeGetBookingSlugStatus:
		// smbToolConfigParams.GetBookingSlugStatusParams is populated
	case components.SMBToolConfigParamsTypeGetClientAppointments:
		// smbToolConfigParams.GetClientAppointmentsParams is populated
	case components.SMBToolConfigParamsTypeGetClientByPhone:
	...
	case components.SMBToolConfigParamsTypeListAssets:
		// smbToolConfigParams.ListAssetsParams is populated
	case components.SMBToolConfigParamsTypeListCalendarEvents:
		// smbToolConfigParams.ListCalendarEventsParams is populated
	case components.SMBToolConfigParamsTypeListClientInteractions:
	...
	case components.SMBToolConfigParamsTypeUpdateBusinessInfo:
		// smbToolConfigParams.UpdateBusinessInfoParams is populated
	case components.SMBToolConfigParamsTypeUpdateCalendarEvent:
		// smbToolConfigParams.UpdateCalendarEventParams is populated
	case components.SMBToolConfigParamsTypeUpdateClient:

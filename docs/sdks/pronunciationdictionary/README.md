...
func main() {
    ...
    res, err := s.PronunciationDictionary.GetPronunciationDictionariesMetadata(ctx, nil, elevenlabsgo.Pointer[int64](30), operations.GetPronunciationDictionariesMetadataSortCreationTimeUnix.ToPointer(), elevenlabsgo.Pointer("descending"))
    if err != nil {
        log.Fatal(err)
    }
...
| `sort`                                                                                                                      | [*operations.GetPronunciationDictionariesMetadataSort](../../models/operations/getpronunciationdictionariesmetadatasort.md) | :heavy_minus_sign:                                                                                                          | Which field to sort by, one of 'created_at_unix' or 'name'.                                                                 | creation_time_unix                                                                                                          |

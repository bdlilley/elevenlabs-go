...
func main() {
    ...
    res, err := s.Resource.GetDubbingResource(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Resource.UpdateSegmentLanguage(ctx, "<id>", "<id>", "<value>", components.SegmentUpdatePayload{})
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Resource.DeleteSegment(ctx, "<id>", "<id>")
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Resource.UpdateSpeaker(ctx, "<id>", "<id>", nil)
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Resource.CreateSpeaker(ctx, "<id>", nil)
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Resource.GetSimilarVoicesForSpeaker(ctx, "<id>", "<id>")
    if err != nil {
        log.Fatal(err)
    }

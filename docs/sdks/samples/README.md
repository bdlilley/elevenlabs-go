...
func main() {
    ...
    res, err := s.Samples.DeleteSample(ctx, "21m00Tcm4TlvDq8ikWAM", "VW7YKqPnjY4h39yTbx2L")
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Samples.GetAudioFromSample(ctx, "21m00Tcm4TlvDq8ikWAM", "VW7YKqPnjY4h39yTbx2L")
    if err != nil {
        log.Fatal(err)
    }
    if res != nil {

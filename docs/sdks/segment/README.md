...
func main() {
    ...
    res, err := s.Segment.GetDubbingResource(ctx, "<id>")
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Segment.UpdateSegmentLanguage(ctx, "<id>", "<id>", "<value>", components.SegmentUpdatePayload{})
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Segment.DeleteSegment(ctx, "<id>", "<id>")
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Segment.UpdateSpeaker(ctx, "<id>", "<id>", nil)
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Segment.CreateSpeaker(ctx, "<id>", nil)
    if err != nil {
        log.Fatal(err)
    }
...
func main() {
    ...
    res, err := s.Segment.GetSimilarVoicesForSpeaker(ctx, "<id>", "<id>")
    if err != nil {
        log.Fatal(err)
    }

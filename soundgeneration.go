...
// SoundGeneration - Generate sound effects and non-speech audio from a text prompt.
...
func newSoundGeneration(rootSDK *ElevenlabsGo, sdkConfig config.SDKConfiguration, hooks *hooks.Hooks) *SoundGeneration {
...
func (s *SoundGeneration) SoundGeneration(ctx context.Context, body components.BodySoundGenerationV1SoundGenerationPost, outputFormat *components.AllowedOutputFormats, opts ...operations.Option) (*operations.SoundGenerationResponse, error) {
	...
	opURL, err := url.JoinPath(baseURL, "/v1/sound-generation")
	if err != nil {
	...
	res := &operations.SoundGenerationResponse{
